...
ulang = {
	...
	_cm_stats_toggle = '開關 統計信息',
	_cm_console_on = '顯示控制檯',	
	_cm_border_toggle = '切換 窗口邊框',
	_cm_ontop_toggle = '切換 窗口置頂',
	_cm_audio_device = '※ 音頻設備列表',
	...
	_vid_menu = '影片',
	_import_id_menu = '導入 ',
	_import_id_footnote = '粘貼URL可直接加載文件 Ctrl+v。返回上級路徑 Alt+UP',
...
--	_menu_item_empty_title = '空',
	...
	_error = '出錯 詳見控制檯',
	_clipboard_osd = '複製到剪貼板',
	_clipboard_osd2 = '無可複製',

	_sid_submenu_title = '字幕軌列表',
	_sid_submenu_label1 = '開/關 次字幕',
	_sid_submenu_label2 = '重載',
	_sid_submenu_label3 = '移除',
--	_sid_sec_submenu_title = '次字幕軌列表',
	_aid_submenu_title = '音軌列表',
	_vid_submenu_title = '片軌列表',
	_xid_submenu_footnote = '再次點擊條目可禁用該項。粘貼URL可直接添加 Ctrl+v',
	_playlist_submenu_title = '播放列表',
	_playlist_submenu_footnote = '粘貼URL可直接添加文件 Ctrl+v。排序 Ctrl+UP/DOWN/PGUP/PGDWN/HOME/END',
...
--	_submenu_id_disabled = '禁用',
	...
	_submenu_file_browser_label2 = '將此目錄作為播放列表加載',
